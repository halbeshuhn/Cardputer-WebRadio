...
static const char* const langStrings[LANG_COUNT][STR_COUNT] = {
  ...
  // ----- LANG_DE ----------------------------------------------------------
  {
    ...
    "lade Sender...",    // STR_LOADING_STATION
    // Sleeptime bleibt in beiden Sprachen gleich: Ecki hat den Eintrag so
    // benannt, und "Einschlafzeit" waere zu breit fuer das Fenster.
    "Sleeptime",         // STR_MENU_SLEEP
    "Sleep -> STOP",     // STR_MENU_SLEEP_STOP
    "Sprache",           // STR_MENU_LANG
    "Testlauf",          // STR_MENU_TEST
    "Charge Mode",       // STR_MENU_CHARGE
    "Exit",              // STR_MENU_EXIT
  ...
  // ----- LANG_EN ----------------------------------------------------------
  {
    ...
    "loading Station...",// STR_LOADING_STATION
    "Sleeptime",         // STR_MENU_SLEEP
    "Sleep -> STOP",     // STR_MENU_SLEEP_STOP
