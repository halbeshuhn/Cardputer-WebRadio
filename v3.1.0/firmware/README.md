...
|---|---|---|---|
| `Cardputer-WebRadio_v3.1.0.bin` | 1.7 MB | application only | SD card / M5Launcher |
| `Cardputer-WebRadio_v3.1.0_merged.bin` | 4.2 MB | bootloader + partition table + application | address `0x0` |
...
```
Sketch:          1,616,591 bytes (51% of 3,145,728)
Global variables:   73,052 bytes (22% of 327,680)
```
