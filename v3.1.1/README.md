...
| File | Size | Use with |
|---|---|---|
| `Cardputer-WebRadio_v3.1.1.bin` | 1.7 MB | SD card / M5Launcher — application only |
| `Cardputer-WebRadio_v3.1.1_merged.bin` | 4.2 MB | M5Burner, ESP Web Flasher — complete image, write to `0x0` |
