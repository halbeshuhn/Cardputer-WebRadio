...
def _array_body(name, path=SKETCH):
    ...
    text = _text(path)
    # Auch Tabellen mit angegebener Groesse - eqFreqLabel[EQ_BANDS] etwa. Im
    # Sketch ist die Angabe das Bessere: zu viele Eintraege faellt dann schon
    # beim Uebersetzen auf.
